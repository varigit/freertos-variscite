...
#define RX_BUFFER_LEN         (18 * 1024) /* 72ms * 4channels * 16KHz * 32bits*/
...
#if VOICE_ENGINE_CONFIG_VOICESEEKER_2MIC
static const rdsp_coordinate_xyz_t mics_coords[2] = {{-17.5f, 0.0f, 0.0f}, {17.5f, 0.0f, 0.0f}};
static RETUNE_VOICESEEKERLIGHT_plugin_t vsl       = {0};
static rdsp_voiceseekerlight_config_t vsl_config;

#define VOICESPOT_HEAP_SIZE    (38496)
#define VOICESPOT_SCRATCH_SIZE (3840)
static uint8_t voiceseeker_heap[VOICESPOT_HEAP_SIZE];
static uint8_t voiceseeker_scratch[VOICESPOT_SCRATCH_SIZE];
...
static void voiceseeker_2mic_init(void)
{
    ...
    vsl.mem.pPrivateDataBase    = (void *)voiceseeker_heap;
    vsl.mem.pPrivateDataNext    = (void *)voiceseeker_heap;
    vsl.mem.FreePrivateDataSize = VOICESPOT_HEAP_SIZE;
    vsl.mem.pScratchDataBase    = (void *)voiceseeker_scratch;
    vsl.mem.pScratchDataNext    = (void *)voiceseeker_scratch;
    vsl.mem.FreeScratchDataSize = VOICESPOT_SCRATCH_SIZE;
    ...
    vsl_config.mic_xyz_mm           = (rdsp_coordinate_xyz_t *)mics_coords;
