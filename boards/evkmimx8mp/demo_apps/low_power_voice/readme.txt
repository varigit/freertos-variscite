...
2.  Make sure the FDT file is correctly set before booting the linux kernel. The following command can be used to set FDT file in uboot console:
    ...
    Set the environment variables using following command:
...
4. When voice is detected by M core, Linux will resume and audio record will continue on Linux.
...
VIT release: 0xa0200
Memory region 0, size 271 in Bytes,  kBytes
 Memory region address 0x20013EC8
Memory region 1, size 4031 in Bytes,  kBytes
 Memory region address 0x20013FE0
Memory region 2, size 47 in Bytes,  kBytes
 Memory region address 0x20014FA8
Memory region 3, size 591 in Bytes,  kBytes
 Memory region address 0x20014FE0
********************************
