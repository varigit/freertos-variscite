...
app_dpu_stream_t safetyStream = {
    ...
    .hscalerSrc = kDPU_UnitSrcFetchYUV1,
#else
    .vscalerSrc       = kDPU_UnitSrcFetchYUV1,
    ...
    .extDstSrc = kDPU_UnitSrcLayerBlend4,
...
app_dpu_stream_t contentStream = {
...
#if (APP_VIDEO_PLANE_WIDTH > APP_STREAM_WIDTH)
    .vscalerSrc = kDPU_UnitSrcHScaler4,
    .hscalerSrc = kDPU_UnitSrcFetchYUV0,
#else
    .vscalerSrc       = kDPU_UnitSrcFetchYUV0,
    .hscalerSrc       = kDPU_UnitSrcVScaler4,
#endif
    ...
    .extDstSrc = kDPU_UnitSrcLayerBlend1,
...
void APP_InitStream(app_dpu_stream_t *stream)
{
    ...
    DPU_EnableInterrupts(APP_DPU_DC, 0, stream->intGroup0);

    /* Trigger domainblend shadow load interrupt. */
