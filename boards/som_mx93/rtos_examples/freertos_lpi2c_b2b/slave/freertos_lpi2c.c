...
/*master: 0  slave:1*/
#define I2C_MASTER_SLAVE 1

#define EXAMPLE_I2C_SLAVE_BASE (LPI2C7_BASE)
#define EXAMPLE_I2C_SLAVE_IRQN (LPI2C7_IRQn)
#define LPI2C_CLOCK_ROOT       kCLOCK_Root_Lpi2c7
#define LPI2C_CLOCK_FREQUENCY  CLOCK_GetIpFreq(LPI2C_CLOCK_ROOT)
/* clang-format off */
/*
...
int main(void)
{
    ...
    CLOCK_SetRootClock(LPI2C_CLOCK_ROOT, &lpi2cClkCfg);
