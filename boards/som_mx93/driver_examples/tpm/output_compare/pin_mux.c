...
- pin_list:
  ...
  - {pin_num: W21, peripheral: TPM6, signal: 'tpm_ch, 0', pin_signal: GPIO_IO27, HYS: DISABLED, PD: DISABLED, FSEL1: SlOW_SLEW_RATE}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
