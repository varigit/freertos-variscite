...
- pin_list:
  - {pin_num: J21, peripheral: LPUART7, signal: lpuart_tx, pin_signal: GPIO_IO00, HYS: DISABLED, PD: DISABLED, FSEL1: SlOW_SLEW_RATE}
  - {pin_num: J20, peripheral: LPUART7, signal: lpuart_rx, pin_signal: GPIO_IO01, HYS: DISABLED, PD: ENABLED, FSEL1: SlOW_SLEW_RATE, DSE: NO_DRIVE}
  - {pin_num: J21, peripheral: LPSPI6, signal: 'lpspi_pcs, 0', pin_signal: GPIO_IO00, PD: ENABLED}
  - {pin_num: K21, peripheral: LPSPI6, signal: lpspi_sck, pin_signal: GPIO_IO03, PD: ENABLED}
  - {pin_num: J20, peripheral: LPSPI6, signal: lpspi_sin, pin_signal: GPIO_IO01, PD: ENABLED}
  - {pin_num: K20, peripheral: LPSPI6, signal: lpspi_sout, pin_signal: GPIO_IO02, PD: ENABLED}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitPins(void) {                                /*!< Function assigned for the core: undefined[cm33] */
    IOMUXC_SetPinMux(IOMUXC_PAD_GPIO_IO00__LPSPI6_PCS0, 0U);
    ...
    IOMUXC_SetPinConfig(IOMUXC_PAD_GPIO_IO00__LPSPI6_PCS0, 
                        IOMUXC_PAD_DSE(15U) |
                        IOMUXC_PAD_FSEL1(2U) |
                        IOMUXC_PAD_PD_MASK);
