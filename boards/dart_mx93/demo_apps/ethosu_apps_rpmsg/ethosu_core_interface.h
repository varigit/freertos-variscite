...
struct ethosu_core_network_info_rsp {
	...
	uint32_t ifm_types[ETHOSU_CORE_BUFFER_MAX];
	uint32_t ifm_offset[ETHOSU_CORE_BUFFER_MAX];
	uint32_t ifm_dims[ETHOSU_CORE_BUFFER_MAX];
	uint32_t ifm_shapes[ETHOSU_CORE_BUFFER_MAX][ETHOSU_CORE_DIM_MAX];
	uint32_t ofm_count;
	uint32_t ofm_size[ETHOSU_CORE_BUFFER_MAX];
	uint32_t ofm_types[ETHOSU_CORE_BUFFER_MAX];
	uint32_t ofm_offset[ETHOSU_CORE_BUFFER_MAX];
	uint32_t ofm_dims[ETHOSU_CORE_BUFFER_MAX];
	uint32_t ofm_shapes[ETHOSU_CORE_BUFFER_MAX][ETHOSU_CORE_DIM_MAX];
	uint32_t status;
};
