 ...
 * Definitions
 ******************************************************************************/
#define EXAMPLE_LPSPI_MASTER_BASEADDR         LPSPI5
#define LPSPI_MASTER_CLOCK_ROOT               kCLOCK_Root_Lpspi5
#define LPSPI_MASTER_CLOCK_GATE               kCLOCK_Lpspi5
#define LPSPI_MASTER_CLK_FREQ                 (CLOCK_GetIpFreq(LPSPI_MASTER_CLOCK_ROOT))
#define EXAMPLE_LPSPI_MASTER_PCS_FOR_INIT     kLPSPI_Pcs0
#define EXAMPLE_LPSPI_MASTER_PCS_FOR_TRANSFER kLPSPI_MasterPcs0
#define EXAMPLE_LPSPI_MASTER_IRQN             LPSPI5_IRQn
#define EXAMPLE_LPSPI_MASTER_IRQHandler       LPSPI5_IRQHandler
