 ...
 * Definitions
 ******************************************************************************/
#define EXAMPLE_LPSPI_SLAVE_BASEADDR         LPSPI5
#define EXAMPLE_LPSPI_SLAVE_IRQN             LPSPI5_IRQn
#define EXAMPLE_LPSPI_SLAVE_IRQHandler       LPSPI5_IRQHandler
#define EXAMPLE_LPSPI_SLAVE_PCS_FOR_INIT     kLPSPI_Pcs0
#define EXAMPLE_LPSPI_SLAVE_PCS_FOR_TRANSFER kLPSPI_SlavePcs0

#define EXAMPLE_LPSPI_SLAVE_CLOCK_NAME (LPSPI_SLAVE_CLOCK_ROOT)
#define LPSPI_SLAVE_CLOCK_ROOT         kCLOCK_Root_Lpspi5
#define LPSPI_SLAVE_CLOCK_GATE         kCLOCK_Lpspi5
