...
Since no LED connected to the RGPIO. Please use oscilloscope probe to the pin (J12.14) to check the output (3.3V) to check the output. The output will toggle periodically.
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
