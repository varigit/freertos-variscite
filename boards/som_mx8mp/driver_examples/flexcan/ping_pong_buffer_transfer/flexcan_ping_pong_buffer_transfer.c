...
#define EXAMPLE_FLEXCAN_RxWarningIRQn CAN_FD2_IRQn
#define EXAMPLE_FLEXCAN_BusOffIRQn    CAN_FD2_IRQn
#define EXAMPLE_FLEXCAN_ErrorIRQn     CAN_FD2_IRQn
#define EXAMPLE_FLEXCAN_MBIRQn        CAN_FD2_IRQn
#define EXAMPLE_FLEXCAN_IRQHandler    CAN_FD2_IRQHandler
