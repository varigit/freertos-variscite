...
- pin_list:
  - {pin_num: AJ4, peripheral: FLEXCAN2, signal: can_rx, pin_signal: UART3_TXD, PUE: Weak_Pull_Up, FSEL: Fast, DSE: X4}
  - {pin_num: AE6, peripheral: FLEXCAN2, signal: can_tx, pin_signal: UART3_RXD, PUE: Weak_Pull_Up, FSEL: Fast, DSE: X4}
