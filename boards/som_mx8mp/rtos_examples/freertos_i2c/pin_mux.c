...
- pin_list:
  ...
  - {pin_num: AF8, peripheral: I2C4, signal: i2c_scl, pin_signal: I2C4_SCL, PE: Enabled, HYS: Schmitt, PUE: Weak_Pull_Up, FSEL: Fast, DSE: X6, SION: ENABLED}
  - {pin_num: AD8, peripheral: I2C4, signal: i2c_sda, pin_signal: I2C4_SDA, PE: Enabled, HYS: Schmitt, PUE: Weak_Pull_Up, FSEL: Fast, DSE: X6, SION: ENABLED}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
