...
- pin_list:
  - {pin_num: AH15, peripheral: FLEXCAN1, signal: can_rx, pin_signal: SAI2_TXC, PUE: Weak_Pull_Up, FSEL: Fast, DSE: X4}
  - {pin_num: AJ16, peripheral: FLEXCAN1, signal: can_tx, pin_signal: SAI2_RXC, PUE: Weak_Pull_Up, FSEL: Fast, DSE: X4}
  - {pin_num: AE6, peripheral: UART3, signal: uart_rx, pin_signal: UART3_RXD, PUE: Weak_Pull_Up, DSE: X6}
  - {pin_num: AJ4, peripheral: UART3, signal: uart_tx, pin_signal: UART3_TXD, PUE: Weak_Pull_Up, DSE: X6}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitPins(void) {                                /*!< Function assigned for the core: Cortex-M7F[m7] */
    ...
    IOMUXC_SetPinConfig(IOMUXC_SAI2_RXC_CAN1_TX, 
                        IOMUXC_SW_PAD_CTL_PAD_DSE(1U) |
                        IOMUXC_SW_PAD_CTL_PAD_FSEL_MASK |
                        IOMUXC_SW_PAD_CTL_PAD_PUE_MASK |
                        IOMUXC_SW_PAD_CTL_PAD_PE_MASK);
