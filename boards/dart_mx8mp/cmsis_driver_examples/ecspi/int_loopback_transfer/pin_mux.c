...
- pin_list:
  - {pin_num: AE6, peripheral: UART3, signal: uart_rx, pin_signal: UART3_RXD, PE: Enabled, PUE: Weak_Pull_Up, DSE: X1}
  - {pin_num: AJ4, peripheral: UART3, signal: uart_tx, pin_signal: UART3_TXD, PE: Enabled, PUE: Weak_Pull_Up, DSE: X1}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
- options: {callFromInitBoot: 'false', coreID: m7}
- pin_list:
  - {pin_num: AF20, peripheral: GPIO5, signal: 'gpio_io, 6', pin_signal: ECSPI1_SCLK}
  - {pin_num: AC20, peripheral: GPIO5, signal: 'gpio_io, 7', pin_signal: ECSPI1_MOSI}
  - {pin_num: AD20, peripheral: GPIO5, signal: 'gpio_io, 8', pin_signal: ECSPI1_MISO}
  - {pin_num: AE20, peripheral: GPIO5, signal: 'gpio_io, 9', pin_signal: ECSPI1_SS0}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
- options: {callFromInitBoot: 'false', coreID: m7}
- pin_list:
  - {pin_num: AD20, peripheral: ECSPI1, signal: ecspi_miso, pin_signal: ECSPI1_MISO, PE: Disabled, HYS: Schmitt, ODE: Disabled, FSEL: Slow, DSE: X2}
