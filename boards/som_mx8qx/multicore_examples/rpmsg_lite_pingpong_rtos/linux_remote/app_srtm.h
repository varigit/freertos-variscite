...
#define EXAMPLE_LPI2C_MASTER ADMA__LPI2C3
#define EXAMPLE_LPI2C_BAUDRATE (100000) /*in i2c example it is 100000*/
#define I2C_SOURCE_CLOCK_FREQ_LPI2C3 CLOCK_GetIpFreq(kCLOCK_DMA_Lpi2c3) /*ADMA_LPI2C3*/
...
static LPI2C_Type *const lpi2cInstanceTable[] = {EXAMPLE_LPI2C_MASTER};
static uint32_t const lpi2cBaudrateTable[]    = {EXAMPLE_LPI2C_BAUDRATE};
/*******************************************************************************
 * API
 ******************************************************************************/
