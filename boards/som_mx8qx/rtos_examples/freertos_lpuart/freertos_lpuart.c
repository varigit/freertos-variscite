...
#define DEMO_LPUART_CLK_FREQ   CLOCK_GetIpFreq(DEMO_LPUART_CLKSRC)
#define DEMO_LPUART_RSRC       SC_R_UART_1
#define DEMO_LPUART_RX_TX_IRQn ADMA_UART1_INT_IRQn
/* Task priorities. */
...
int main(void)
{
    ...
    if (sc_pm_set_resource_power_mode(ipc, DEMO_LPUART_RSRC, SC_PM_PW_MODE_ON) != SC_ERR_NONE)
    {
        assert(false);
    }
