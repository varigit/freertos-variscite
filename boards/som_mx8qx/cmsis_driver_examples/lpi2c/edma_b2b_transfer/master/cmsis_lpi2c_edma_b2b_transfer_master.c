...
int main(void)
{
    ...
    i = sc_pm_set_resource_power_mode(ipc, SC_R_DMA_3_CH6, SC_PM_PW_MODE_ON);
    if (i != SC_ERR_NONE)
    {
        PRINTF("Error: Failed to power on SC_R_DMA_3_CH6, error %d\r\n", i);
    };
    i = sc_pm_set_resource_power_mode(ipc, SC_R_DMA_3_CH7, SC_PM_PW_MODE_ON);
    if (i != SC_ERR_NONE)
    {
        PRINTF("Error: Failed to power on SC_R_DMA_3_CH7, error %d\r\n", i);
    }
