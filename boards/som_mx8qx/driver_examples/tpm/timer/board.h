...
#define BOARD_NAME "VAR-SOM-MX8X"

/* The UART to use for debug messages. */
#define BOARD_DEBUG_UART_TYPE kSerialPort_Uart
#define BOARD_DEBUG_UART_BAUDRATE 115200u
#define BOARD_DEBUG_UART_BASEADDR (uint32_t) ADMA__LPUART1
#define BOARD_DEBUG_UART_INSTANCE 1U
#define BOARD_DEBUG_UART_SC_RSRC SC_R_UART_1
#define BOARD_DEBUG_UART_CLK_FREQ 6000000u
#define BOARD_UART_IRQ ADMA_UART1_INT_IRQn
#define BOARD_UART_IRQ_HANDLER LPUART1_IRQHandler
#define BOARD_DEBUG_UART_CLKSRC kCLOCK_DMA_Lpuart1
