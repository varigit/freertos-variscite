 ...
 * Definitions
 ******************************************************************************/
#define EXAMPLE_I2C_MASTER_BASE ADMA__LPI2C3
#define EXAMPLE_LPI2C_MASTER_DMA ADMA__EDMA3
#define LPI2C_TRANSMIT_DMA_CHANNEL 7U
#define LPI2C_RECEIVE_DMA_CHANNEL 6U
#define LPI2C_MASTER_CLOCK_FREQUENCY CLOCK_GetIpFreq(kCLOCK_DMA_Lpi2c3)
...
int main(void)
{
    ...
    sc_pm_set_resource_power_mode(ipc, SC_R_DMA_3_CH6, SC_PM_PW_MODE_ON);
    sc_pm_set_resource_power_mode(ipc, SC_R_DMA_3_CH7, SC_PM_PW_MODE_ON);
    ...
    IRQSTEER_EnableInterrupt(IRQSTEER, ADMA_I2C3_DMA_RX_INT_IRQn);
    IRQSTEER_EnableInterrupt(IRQSTEER, ADMA_I2C3_DMA_TX_INT_IRQn);
