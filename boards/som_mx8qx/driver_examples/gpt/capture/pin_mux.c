...
pin_labels:
- {pin_num: H34, pin_signal: UART1_TX, label: UART1_TX, identifier: UART1_TX}
- {pin_num: V32, pin_signal: ADC_IN2, label: FTDI_M40_UART0_RX, identifier: FTDI_M40_UART0_RX}
- {pin_num: V30, pin_signal: ADC_IN3, label: FTDI_M40_UART0_TX, identifier: FTDI_M40_UART0_TX}
...
- pin_list:
  - {pin_num: V32, peripheral: M40__UART0, signal: uart_rx, pin_signal: ADC_IN2, PULL: PULL_0}
  - {pin_num: V30, peripheral: M40__UART0, signal: uart_tx, pin_signal: ADC_IN3, PULL: PULL_0}
  - {pin_num: H34, peripheral: LSIO__GPT0, signal: gpt_capture, pin_signal: UART1_TX, PULL: PULL_0}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
