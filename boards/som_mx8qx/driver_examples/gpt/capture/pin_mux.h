...
/* UART1_TX (coord H34), UART1_TX */
#define BOARD_INITPINS_UART1_TX_PERIPHERAL                            LSIO__GPT0   /*!< Device name: LSIO__GPT0 */
#define BOARD_INITPINS_UART1_TX_SIGNAL                               gpt_capture   /*!< LSIO__GPT0 signal: gpt_capture */
#define BOARD_INITPINS_UART1_TX_PIN_NAME                                UART1_TX   /*!< Pin name */
#define BOARD_INITPINS_UART1_TX_PIN_FUNCTION_ID                    SC_P_UART1_TX   /*!< Pin function id */
#define BOARD_INITPINS_UART1_TX_LABEL                                 "UART1_TX"   /*!< Label */
