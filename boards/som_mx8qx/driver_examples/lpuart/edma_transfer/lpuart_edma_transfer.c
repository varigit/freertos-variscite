 ...
 * Definitions
 ******************************************************************************/
#define DEMO_LPUART ADMA__LPUART1
#define DEMO_LPUART_CLKSRC kCLOCK_DMA_Lpuart1
#define DEMO_LPUART_CLK_FREQ CLOCK_GetIpFreq(kCLOCK_DMA_Lpuart1)

#define LPUART_TX_DMA_CHANNEL 11U
#define LPUART_RX_DMA_CHANNEL 10U
...
int main(void)
{
    ...
    if (sc_pm_set_resource_power_mode(ipc, SC_R_UART_1, SC_PM_PW_MODE_ON) != SC_ERR_NONE)
    {
        assert(false);
    }
    ...
    sc_pm_set_resource_power_mode(ipc, SC_R_DMA_2_CH10, SC_PM_PW_MODE_ON);
    sc_pm_set_resource_power_mode(ipc, SC_R_DMA_2_CH11, SC_PM_PW_MODE_ON);
    ...
    IRQSTEER_EnableInterrupt(IRQSTEER, ADMA_UART1_DMA_RX_INT_IRQn);
    IRQSTEER_EnableInterrupt(IRQSTEER, ADMA_UART1_DMA_TX_INT_IRQn);
