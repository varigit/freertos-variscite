...
- pin_list:
  ...
  - {pin_num: W29, peripheral: ADMA__ADC, signal: 'adc_in, 4', pin_signal: ADC_IN4, PULL: PULL_0, sw_config: sw_config_0}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitPins(sc_ipc_t ipc)                          /*!< Function assigned for the core: Cortex-M4F[m4] */
{
  ...
  err = sc_pad_set_all(ipc, BOARD_INITPINS_DSI_D1P_PIN_FUNCTION_ID, 0U, SC_PAD_CONFIG_NORMAL, SC_PAD_ISO_OFF, 0x0 ,SC_PAD_WAKEUP_OFF);/* IOMUXD_ADC_IN4 register modification value */
  if (SC_ERR_NONE != err)
  {
      assert(false);
  }
