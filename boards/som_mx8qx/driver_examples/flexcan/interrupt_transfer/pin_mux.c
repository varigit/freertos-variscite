...
- pin_list:
  ...
  - {pin_num: AD34, peripheral: ADMA__FLEXCAN1, signal: flexcan_rx, pin_signal: UART2_RX, PULL: PULL_0, sw_config: sw_config_2}
  - {pin_num: AC35, peripheral: ADMA__FLEXCAN1, signal: flexcan_tx, pin_signal: UART2_TX, PULL: PULL_0, sw_config: sw_config_2}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
