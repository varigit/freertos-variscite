...
#define EXAMPLE_CAN_DMA_CHANNEL (13)
...
int main(void)
{
    ...
    /* Power on EDMA . */
    if (sc_pm_set_resource_power_mode(ipc, SC_R_DMA_3_CH13, SC_PM_PW_MODE_ON) != SC_ERR_NONE)
    {
    ...
    IRQSTEER_EnableInterrupt(IRQSTEER, ADMA_FLEXCAN1_DMA_INT_IRQn);
