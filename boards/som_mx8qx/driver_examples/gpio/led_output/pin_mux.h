...
/* SPI0_SDO (number R31), GPIO1_IO06 */
#define BOARD_INITPINS_SPI0_SDO_GPIO                              LSIO__GPIO1   /*!< GPIO device name: LSIO__GPIO1 */
#define BOARD_INITPINS_SPI0_SDO_GPIO_PIN                                   6U   /*!< LSIO__GPIO1 pin index: 6 */
#define BOARD_INITPINS_SPI0_SDO_PIN_NAME                             SPI0_SDO   /*!< Pin name */
#define BOARD_INITPINS_SPI0_SDO_PIN_FUNCTION_ID                 SC_P_SPI0_SDO   /*!< Pin function id */
#define BOARD_INITPINS_SPI0_SDO_LABEL                            "GPIO1_IO06"   /*!< Label */
#define BOARD_INITPINS_SPI0_SDO_NAME                             "GPIO1_IO06"   /*!< Identifier name */
