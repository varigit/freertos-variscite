...
=====================
- Micro USB cable
- one DART-MX95 SoM on DT8MCB or Sonata boards
- Proper power supply
- Personal Computer
...
5.  Load and start the demo on the M7 using either U-Boot (bootaux) or Linux (remoteproc) per the variwiki guide.
