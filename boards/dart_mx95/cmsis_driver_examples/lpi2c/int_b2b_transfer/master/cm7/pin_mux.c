...
- options: {callFromInitBoot: 'true', coreID: cm33}
- pin_list:
  - {pin_num: C21, peripheral: LPI2C4, signal: lpi2c_sda, pin_signal: GPIO_IO30, SION: ENABLED, OD: ENABLED, PD: DISABLED}
  - {pin_num: C20, peripheral: LPI2C4, signal: lpi2c_scl, pin_signal: GPIO_IO31, SION: ENABLED, OD: ENABLED, PD: DISABLED}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
- pin_list:
  - {pin_num: C20, peripheral: GPIO2, signal: 'gpio_io, 31', pin_signal: GPIO_IO31, SION: ENABLED}
  - {pin_num: C21, peripheral: GPIO2, signal: 'gpio_io, 30', pin_signal: GPIO_IO30, SION: ENABLED}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void LPI2C4_DeinitPins(void) {                             /*!< Function assigned for the core: undefined[cm33] */
    HAL_PinctrlSetPinMux(HAL_PINCTRL_PLATFORM_IOMUXC_PAD_GPIO_IO30__GPIO2_IO_BIT30, 1U);
    HAL_PinctrlSetPinMux(HAL_PINCTRL_PLATFORM_IOMUXC_PAD_GPIO_IO31__GPIO2_IO_BIT31, 1U);
}
