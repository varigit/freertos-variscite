...
- pin_list:
  ...
  - {pin_num: G7, peripheral: I2C3, signal: i2c_scl, pin_signal: I2C3_SCL, LVTTL: Disabled, ODE: Enabled, SION: ENABLED, HYS: Enabled, SRE: MEDIUM}
  - {pin_num: F7, peripheral: I2C3, signal: i2c_sda, pin_signal: I2C3_SDA, LVTTL: Disabled, ODE: Enabled, SION: ENABLED, HYS: Enabled, SRE: MEDIUM}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
