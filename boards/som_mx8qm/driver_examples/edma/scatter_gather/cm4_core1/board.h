...
#else
#define BOARD_DEBUG_UART_BASEADDR (uint32_t) DMA__LPUART4
#define BOARD_DEBUG_UART_INSTANCE 6U
#define BOARD_DEBUG_UART_SC_RSRC SC_R_UART_4
#define BOARD_DEBUG_UART_CLKSRC kCLOCK_DMA_Lpuart4
#define BOARD_UART_IRQ DMA_UART4_INT_IRQn
#define BOARD_UART_IRQ_HANDLER DMA_UART4_INT_IRQHandler
#endif
