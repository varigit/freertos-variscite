...
#define EXAMPLE_LPSPI_MASTER_IRQN             DMA_SPI0_INT_IRQn /*DMA LPSPI 0 interrupt is connected to IRQSteer Master 3 */
#define EXAMPLE_LPSPI_MASTER_PCS_FOR_INIT     kLPSPI_Pcs0
#define EXAMPLE_LPSPI_MASTER_PCS_FOR_TRANSFER kLPSPI_MasterPcs0
#define LPSPI_MASTER_CLK_FREQ                 (CLOCK_GetIpFreq(kCLOCK_DMA_Lpspi0))
#define EXAMPLE_LPSPI_MASTER_IRQHandler       DMA_SPI0_INT_IRQHandler
...
int main(void)
{
    ...
    IRQSTEER_EnableInterrupt(IRQSTEER, DMA_SPI0_INT_IRQn);
