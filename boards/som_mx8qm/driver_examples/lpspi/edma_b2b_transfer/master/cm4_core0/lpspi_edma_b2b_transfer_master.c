 ...
 ******************************************************************************/
/*Master related*/
#define EXAMPLE_LPSPI_MASTER_BASEADDR DMA__LPSPI0
#define EXAMPLE_LPSPI_MASTER_PCS_FOR_INIT kLPSPI_Pcs0
#define EXAMPLE_LPSPI_MASTER_PCS_FOR_TRANSFER kLPSPI_MasterPcs0
#define LPSPI_MASTER_CLK_FREQ (CLOCK_GetIpFreq(kCLOCK_DMA_Lpspi0))
...
int main(void)
{
    ...
    {
        PRINTF("Error: Failed to power on LPSPI0\r\n");
    }
    if (sc_pm_set_resource_power_mode(ipc, SC_R_DMA_0_CH0, SC_PM_PW_MODE_ON) != SC_ERR_NONE)
    {
        PRINTF("Error: Failed to power on DMA Channel\r\n");
    }
    if (sc_pm_set_resource_power_mode(ipc, SC_R_DMA_0_CH1, SC_PM_PW_MODE_ON) != SC_ERR_NONE)
    {
        PRINTF("Error: Failed to power on DMA Channel\r\n");
    }

    /* Setup LPSPI clock */
    freq = CLOCK_SetIpFreq(kCLOCK_DMA_Lpspi0, SC_66MHZ);
    if (freq == 0)
    {
    ...
    IRQSTEER_EnableInterrupt(IRQSTEER, DMA_SPI0_DMA_RX_INT_IRQn);
    IRQSTEER_EnableInterrupt(IRQSTEER, DMA_SPI0_DMA_TX_INT_IRQn);
