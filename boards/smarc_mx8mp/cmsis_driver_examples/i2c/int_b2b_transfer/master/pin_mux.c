...
- pin_list:
  - {pin_num: AH6, peripheral: GPIO5, signal: 'gpio_io, 16', pin_signal: I2C2_SCL}
  - {pin_num: AD8, peripheral: GPIO5, signal: 'gpio_io, 17', pin_signal: I2C2_SDA}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
- options: {callFromInitBoot: 'false', coreID: cm7}
- pin_list:
  - {pin_num: AH6, peripheral: I2C2, signal: i2c_scl, pin_signal: I2C2_SCL, PE: Enabled, PUE: Weak_Pull_Up, FSEL: Fast, DSE: X6, SION: ENABLED}
  - {pin_num: AE8, peripheral: I2C2, signal: i2c_sda, pin_signal: I2C2_SDA, PE: Enabled, PUE: Weak_Pull_Up, FSEL: Fast, DSE: X6, SION: ENABLED}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
