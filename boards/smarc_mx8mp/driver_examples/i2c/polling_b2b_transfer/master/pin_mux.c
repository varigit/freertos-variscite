...
- pin_list:
  ...
  - {pin_num: AH6, peripheral: I2C2, signal: i2c_scl, pin_signal: I2C2_SCL, PE: Enabled, HYS: Schmitt, PUE: Weak_Pull_Up, FSEL: Fast, DSE: X6, SION: ENABLED}
  - {pin_num: AE8, peripheral: I2C2, signal: i2c_sda, pin_signal: I2C2_SDA, PE: Enabled, HYS: Schmitt, PUE: Weak_Pull_Up, FSEL: Fast, DSE: X6, SION: ENABLED}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
