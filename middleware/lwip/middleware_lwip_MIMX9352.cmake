...
#OR Logic component
if(CONFIG_USE_middleware_lwip_empty_ethernetif_MIMX9352)
     include(middleware_lwip_empty_ethernetif_MIMX9352)
endif()
if(CONFIG_USE_middleware_lwip_usb_ethernetif_MIMX9352)
     include(middleware_lwip_usb_ethernetif_MIMX9352)
endif()
if(CONFIG_USE_middleware_lwip_enet_ethernetif_MIMX9352)
     include(middleware_lwip_enet_ethernetif_MIMX9352)
endif()
if(CONFIG_USE_middleware_lwip_netc_ethernetif_MIMX9352)
     include(middleware_lwip_netc_ethernetif_MIMX9352)
endif()
if(NOT (CONFIG_USE_middleware_lwip_empty_ethernetif_MIMX9352 OR CONFIG_USE_middleware_lwip_usb_ethernetif_MIMX9352 OR CONFIG_USE_middleware_lwip_enet_ethernetif_MIMX9352 OR CONFIG_USE_middleware_lwip_netc_ethernetif_MIMX9352))
    message(WARNING "Since middleware_lwip_empty_ethernetif_MIMX9352/middleware_lwip_usb_ethernetif_MIMX9352/middleware_lwip_enet_ethernetif_MIMX9352/middleware_lwip_netc_ethernetif_MIMX9352 is not included at first or config in config.cmake file, use middleware_lwip_empty_ethernetif_MIMX9352 by default.")
    include(middleware_lwip_empty_ethernetif_MIMX9352)
endif()
