...
#define SM_PLATFORM_PINCTRL_SION_MASK  (0x10U)
...
#define SM_PLATFORM_PINCTRL_CFGREG_OFF   (SM_PLATFORM_PINCTRL_BASE + 0x204U) /* 0x443c0204 */
#define SM_PLATFORM_PINCTRL_DAISYREG_OFF (SM_PLATFORM_PINCTRL_BASE + 0x408U) /* 0x443c0408 */
...
#ifndef SCMI_LM_REQUEST_M7_SUSPEND_ENABLE
